...
RSpec.describe "/investments", type: :request do
  ...
  # InvestmentsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get investments_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new Investment" do
        expect {
          post investments_url,
               params: { investment: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Investment" do
        expect {
          post investments_url,
               params: { investment: invalid_attributes }, as: :json
        }.to change(Investment, :count).by(0)
      end

      it "renders a JSON response with errors for the new investment" do
        post investments_url,
             params: { investment: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested investment" do
        investment = Investment.create! valid_attributes
        patch investment_url(investment),
              params: { investment: new_attributes }, headers: valid_headers, as: :json
        investment.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested investment" do
      investment = Investment.create! valid_attributes
      expect {
        delete investment_url(investment), headers: valid_headers, as: :json
      }.to change(Investment, :count).by(-1)
    end
  end
end
